...
class HostDog implements Countable, Iterator
{
    const DEBUG = false;
    const EXCLUDED_TEST = '';

    const TEST_PHP_VERSION = '5.5.16';
    ...
    // ================================================================================================================
    // HERE COMES THE LAND OF DRAGONS !
    // DON'T CHANGE ANYTHING ABOVE THIS LINE.
    //
    // SO ... DON'T CHANGE ANYTHING AT ALL !
    // ================================================================================================================
        ...
        if (array_key_exists('dbconnect', $_POST)) {
            try {
                ...
                if (empty($_POST['dbhost']) || empty($_POST['dbuser']) || empty($_POST['dbpass']) || empty($_POST['dbname'])) {
                    throw new HostDogException('All fields are required.');
                }
    ...
    public function sendEmail()
    {
        ...
        if (array_key_exists('sendemail', $_POST)) {
            try {
                ...
                if (empty($to)) {
                    throw new HostDogException('A valid Email is required.');
                }
...
class HostDogException extends Exception {}

// ====================================================================================================================

$app = HostDog::factory()->run();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>HostDog - Test your hosting for Dogstudio CMS</title>
    ...
    <body>
        <div class="container">
            <div class="page-header">
                ...
                <h1>HostDog</h1>
                <p class="lead">Test your hosting for Dogstudio CMS.</p>
            </div>
            ...
            <p class="small"><i class="glyphicon glyphicon-eye-open"></i> Click on box heading to see more informations.</p>
        </div>
